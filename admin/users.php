    ...
    <div class="settings-grid">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($u['username'] === $_SESSION['admin_username']): ?>
                                <span class="badge" style="background:var(--gray)">Te / You</span>
                            <?php endif; ?>
                        </td>
                        ...
                        <td>
                            <form method="POST" style="display:flex;gap:.4rem;align-items:center">
                                ...
                                <input type="password" name="new_password" placeholder="Új jelszó" minlength="6"
                                       style="padding:.3rem .6rem;font-size:.82rem;width:130px;border:1px solid var(--gray-border);border-radius:3px">
                        ...
                        <td>
                            <?php if ($u['username'] !== $_SESSION['admin_username']): ?>
                                <a href="?delete=<?= $u['id'] ?>"
                                   ...
                                   onclick="return confirm('Biztosan törli: <?= e($u['username']) ?>?')">&#128465; Töröl</a>
                            <?php else: ?>
                                <span style="color:var(--gray);font-size:.82rem">–</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
        ...
        <div class="form-card">
            ...
            <form method="POST">
                ...
                <button type="submit" name="add_user" class="btn btn-primary">&#43; Felhasználó létrehozása</button>
            </form>
        </div>
